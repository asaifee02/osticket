...
$showing = $pageNav->showing().' '._N('Product', 'Products', $count);
    ...
    <div class="sticky bar opaque">
        <div class="content">
            ...
            <div class="pull-right flush-right">
                ...
                <?php } ?>
                <a href="helptopics.php?a=add" class="green button action-button"><i class="icon-plus-sign"></i> <?php echo __('Add New Product');?></a>
...
<?php foreach (OsticketConfig::allTopicSortModes() as $i=>$m)
    echo sprintf('<option value="%s"%s>%s</option>',
        ...
        <tr>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="36%"><?php echo __('Product'); ?></th>
...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo sprintf(__('Are you sure you want to <b>enable</b> %s?'),
            _N('selected Product', 'selected Products', 2));?>
    </p>
    ...
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo sprintf(__('Are you sure you want to DELETE %s?'),
            _N('selected Product', 'selected Products', 2));?></strong></font>
