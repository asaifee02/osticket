...
<table id="hide_priority_level" class="form_table dynamic-forms" width="940" border="0" cellspacing="0" cellpadding="2">
        <?php if ($forms)
...
<script type="text/javascript">
    console.log($("#hide_priority_level tr:nth-child(5)").find("select").attr("value","<?php echo $priority; ?>") );
    $( "#hide_priority_level tr:nth-child(5)" ).hide();
</script>
<!-- Custom code to show/hide priority type -->
<table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <tbody>
