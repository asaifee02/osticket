        ...
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                ...
                <tr>
                    ...
                    <td>
                    <!-- Custom code to show priority type -->
                    <?php 
                        $sql = "SELECT priority FROM ost_ticket__cdata WHERE ticket_id=".$ticket->getId();
                        $res = db_query($sql,false);
                        if($res){
                            $row = db_fetch_row($res);
                            $priority = $row[0];
                            if($priority){
                                $priority_desc = MaximumTicketsPlugin::getPriorityDescription($priority);
                                echo $priority_desc;
                            }
                        } 
                    ?>    
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo DynabicJiraPlugin::getIssueList($ticket->getId()); ?>
                    </td>
                </tr>
                <?php } ?>
                <!--Custom Code for  Jira Plugin -->
                ...
                <tr>
                    ...
                    <td>
                        <?php echo DynabicRedminePlugin::getIssueList($ticket->getId()); ?>
                    </td>
                </tr>
                <?php } ?>
                <!--Custom Code for  Redmine Plugin -->
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100"><?php echo __('Product');?>:</th>
...
<!-- Custom Code to add Support info -->
<?php 
$sql = "SELECT ps_id FROM ost_ticket WHERE ticket_id = ".$ticket->getId();
$res = db_query($sql);
$row = db_fetch_row($res);
$support_id = $row[0];
?>
<?php if($support_id != NULL){ ?>
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">                
                <tr>
                    <th width="100"><?php echo __('Update Count');?>:</th>
                    <td>
                        <a id="issue_count_plus" class="confirm-action" href="#"><button>+</button></a>
                        <div style="display:none;width:550px;" class="dialog" id="issue_count_plus_pop">
                            <h3>Increase Issue Count</h3>
                            <a class="close" href=""><i class="icon-remove-circle"></i></a>
                            <hr/>
                            <p><b>Add Comment:</b></p>
                            <div class="redactor_box no-pjax">
                                <textarea name="issue-count-comments" id="issue-count-comments" cols="30" rows="3" wrap="soft" style="width: 100%; display: none;" class="richtext ifhtml no-bar" placeholder="Optional reason for updating issue count" dir="ltr"></textarea>
                            </div>
                            <hr/>
                            <button onclick="issue_count_plus()" class="float-left submit-button" >Save</button>
                        </div>
                        <script type = "text/javascript">
                        $("#issue_count_plus").on("click",function(e){
                            $("#issue_count_plus_pop").show();
                            $("#overlay").show();
                            $("#issue_count_plus_pop").css({"width":"550px", "top":"65px", "left":"400px"});
                        });
                        </script>

                        <a id="issue_count_minus" class="confirm-action" href="#"><button>-</button></a>
                        <div style="display:none;width:550px;" class="dialog" id="issue_count_minus_pop">
                            <h3>Decrease Issue Count</h3>
                            <a class="close" href=""><i class="icon-remove-circle"></i></a>
                            <hr/>
                            <p><b>Add Comment:</b></p>
                            <div class="redactor_box no-pjax">
                                <textarea name="issue-count-comments-minus" id="issue-count-comments-minus" cols="30" rows="3" wrap="soft" style="width: 100%; display: none;" class="richtext ifhtml no-bar" placeholder="Optional reason for updating issue count" dir="ltr"></textarea>
                            </div>
                            <hr/>
                            <button onclick="issue_count_minus()" class="float-left submit-button" >Save</button>
                        </div>
                        <script type = "text/javascript">
                        $("#issue_count_minus").on("click",function(e){
                            $("#issue_count_minus_pop").show();
                            $("#overlay").show();
                            $("#issue_count_minus_pop").css({"width":"550px", "top":"65px", "left":"400px"});
                        });
                        </script>
                    </td>
                    <script type="text/javascript">
                    function issue_count_plus() {
                        var comment = $("#issue-count-comments").val();
                        var id = <?php echo $ticket->getId(); ?>;
                        var data = '{ "id": '+id+',"comment" : "'+comment+'"}';
                        var $url = 'ajax.php/issue_count_plus.json';
                        $.ajax({
                            type: "POST",
                            url: $url,
                            dataType: 'json',
                            ...
                            success: function(response){
                                ...
                                if(response[0] == 200 ){
                                    alert("Issue Count has been updated!");
                                    location.reload();
                                }
                                else
                                    alert("Could not update Issue count. Subscription expired!");
                            }
                        })
                        .done(function() { 
                        })
                    ...
                    function issue_count_minus() {
                        var comment = $("#issue-count-comments-minus").val();
                        var id = <?php echo $ticket->getId(); ?>;
                        var data = '{ "id": '+id+',"comment" : "'+comment+'"}';
                        var $url = 'ajax.php/issue_count_minus.json';
                        $.ajax({
                            type: "POST",
                            url: $url,
                            dataType: 'json',
                    ...
                    <td>
                        <a id="view_support_plans" class="confirm-action" href="#">View Support plans</a>
                        <div style="display:none;width:950px;" class="dialog" id="view_support_plans_pop">
                            <h3>Support Plans</h3>
                            <a class="close" href=""><i class="icon-remove-circle"></i></a>
                            <hr/>
                            <?php MaximumTicketsPlugin::getAllSupports($ticket->getId());   ?>
                        </div>
                        <script type = "text/javascript">
                        $("#view_support_plans").on("click",function(e){
                            $("#view_support_plans_pop").show();
                            $("#overlay").show();
                            $("#view_support_plans_pop").css({"width":"1000px", "top":"100px", "left":"150px"});
                        });
                        </script>
                    </td>
                </tr>
        ...
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100"><?php echo __('Support Owner');?>:</th>
                    <td><?php echo MaximumTicketsPlugin::getSupportOwnerByTicketId($ticket->getId()); ?></td>
                    <td>
                        <a id="view_support_comments" class="confirm-action" href="#">View Comments</a>
                        <div style="display:none;width:950px;" class="dialog" id="view_support_comments_pop">
                            <h3>Support Logs</h3>
                            <a class="close" href=""><i class="icon-remove-circle"></i></a>
                            <hr/>
                            <?php MaximumTicketsPlugin::getAllSupportsLogs($ticket->getId());   ?>
                        </div>
                        <script type = "text/javascript">
                        $("#view_support_comments").on("click",function(e){
                            $("#view_support_comments_pop").show();
                            $("#overlay").show();
                            $("#view_support_comments_pop").css({"width":"1000px", "top":"100px", "left":"150px"});
                        });
                        </script>
                    </td>
                </tr>
...
>
    <ul class="tabs" id="response-tabs">
        ...
        <!--Custom Code for Jira Plugin -->
        <li><a id="jira_tab" href="#jiraissue"><?php echo __('Issues'); ?></a></li>
        <!--Custom Code for Jira Plugin -->
    </ul>
    <?php
    if ($role->hasPerm(TicketModel::PERM_REPLY)) { ?>
           ...
           <tbody id="to_sec">
            ...
            <tbody id="cc_sec"
             ...
             <tr>
                <td width="120">
                    <?php 
                    //Custom code to comment out "Add Collaborator" feature.
...
<?php } # endif (canned-resonse-enabled)
   ...
   <!--Custom Code for Jira plugin -->
    <?php if(MaximumTicketsPlugin::isPluginActive("Product Jiras")){ ?>
    <form id="jiraissue" action="tickets.php?id=<?php echo $ticket->getId(); ?>#jiraissue" name="jiraissue" method="post" class="hidden tab_content spellcheck exclusive save">
        <?php csrf_token(); ?>
        <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
        <input type="hidden" name="a" value="jiraissue">
        <input type="hidden" name="pageurl" value="<?php echo Misc::currentURL(); ?>">
        <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td width="120">&nbsp;</td>
                <td class="error"><?php echo $errors['jiraissue']; ?></td>
            </tr>
            <?php
            } ?>
            <tr>
                <td width="120" style="vertical-align:top">
                    <label for="assignId"><strong><?php echo __('Jira Issue IDs');?>:</strong></label>
                </td>
                <td>
                    <div>                        
                        <input type="text" name="jira-issue" id="jira-issue" size="60" value="<?php echo DynabicJiraPlugin::getIssuesForForm($ticket->getId()); ?>" >
                        <br/>                        
                        <div class="faded"><?php
                        echo __('Issues numbers - you can add multiple issue ids, separate them with (semicolon - ;)'); ?></div>
                        <span class="error">&nbsp;<?php echo $errors['jira-issue']; ?></span>
                    </div>
                </td>
            </tr>
        </table>
        <p  style="padding-left:165px;">
            <input class="btn_sm" type="submit" value="<?php echo __('Update'); ?>">
    ...
    <!--Custom Code for Redmine plugin -->
    <?php if(MaximumTicketsPlugin::isPluginActive("Dynabic Redmine")){ ?>
    <form id="jiraissue" action="tickets.php?id=<?php echo $ticket->getId(); ?>#redmineissue" name="redmineissue" method="post" class="hidden tab_content spellcheck exclusive save">
        <?php csrf_token(); ?>
        <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">
        <input type="hidden" name="a" value="redmineissue">
        <input type="hidden" name="pageurl" value="<?php echo Misc::currentURL(); ?>">
        <table style="width:100%" border="0" cellspacing="0" cellpadding="3">

            <?php
            if($errors['redmineissue']) {
                ?>
            <tr>
                <td width="120">&nbsp;</td>
                <td class="error"><?php echo $errors['redmineissue']; ?></td>
            </tr>
            <?php
            } ?>
            <tr>
                <td width="120" style="vertical-align:top">
                    <label for="assignId"><strong><?php echo __('Redmine Issue IDs');?>:</strong></label>
                </td>
                <td>
                    <div>                        
                        <input type="text" name="redmine-issue" id="redmine-issue" size="60" value="<?php echo DynabicRedminePlugin::getIssuesForForm($ticket->getId()); ?>" >
                        <br/>                        
                        <div class="faded"><?php
                        echo __('Issues numbers - you can add multiple issue ids, separate them with (semicolon - ;)'); ?></div>
                        <span class="error">&nbsp;<?php echo $errors['redmine-issue']; ?></span>
                    </div>
                </td>
            </tr>
        </table>
...
<!--Custom Code for  Jira Plugin -->
<?php if(MaximumTicketsPlugin::isPluginActive("Product Jiras")){ ?>
<?php echo DynabicJiraPlugin::getJiraDetails($ticket->getId()); ?><!-- Jira Plugin -->
<?php } ?>
<!--Custom Code for  Jira Plugin -->                
<!--Custom Code for  Redmine Plugin -->
<?php if(MaximumTicketsPlugin::isPluginActive("Dynabic Redmine")){ ?>
<?php echo DynabicRedminePlugin::getRedmineDetails($ticket->getId()); ?><!-- Redmine Plugin -->
<?php } ?>
<!--Custom Code for  Redmine Plugin -->
<script type="text/javascript">
$(function() {
