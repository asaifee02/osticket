...
class PageNate {
    ...
    function getPageLinks($hash=false, $pjax=false) {
        ...
        if($start_loop>1){
            ...
            $html .= "\n<a href=\"$file&p=$lastspan$display_all\" ><strong>&laquo;</strong></a>";
        }
        ...
        for ($i=$start_loop; $i <= $stop_loop; $i++) {
            ...
            elseif ($pjax) {
                ...
                $html .= "\n<a href=\"{$href}{$display_all}\" ><b>$i</b></a>";
            }
        }
        if($stop_loop<$total_pages){
            ...
            if ($hash)
                $href .= '#'.$hash;
            $html .= "\n<a href=\"{$href}{$display_all}\" ><strong>&raquo;</strong></a>";
        }
