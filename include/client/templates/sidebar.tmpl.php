...
<?php
    if ($cfg->getClientRegistrationMode() != 'disabled'
        || !$cfg->isClientLoginRequired()) { ?>
            <a href="login.php?do=ext&bk=dynabic.passport.client" style="display:block" class="blue button"><?php
                echo __('Open a New Ticket');?></a>
</p>
<?php } ?>
<p>
            <a href="login.php?do=ext&bk=dynabic.passport.client" style="display:block" class="green button"><?php
