...
foreach ($faqs as $F) {
        ...
        $id = KnowledgeBasePlugin::cleanString($F->getQuestion()); //Custom code to make seo friendly FAQ urls
        echo sprintf('
            <li><a href="faq/%s" >%s &nbsp;%s</a></li>',
            $id,Format::htmlchars($F->question), $attachments);
    }
    echo '  </ol>
         </div>';
}else {
...
<div class="span4">
    ...
    <div class="content">
        <section>
            <div class="header"><?php echo __('Products'); ?></div>
<?php
