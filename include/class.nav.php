        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'settings':
                    ...
                    break;
                case 'manage':
                    $subnav[]=array('desc'=>__('Products'),'href'=>'helptopics.php','iconclass'=>'helpTopics');
        ...
        if(!$this->navs){
            ...
            if ($cfg->getClientRegistrationMode() != 'disabled'
                ...
                if($user && !$user->isGuest()) {
                    ...
                    $navs['new']=array('desc'=>__('Open a New Ticket'),'href'=>'login.php?do=ext&bk=dynabic.passport.client','title'=>'');   
                }
            }
            //Custom Code for Passport Integration
            if($user && $user->isValid()) {
                if(!$user->isGuest()) {
                    ...
                    //Custom Code to integrate paid support dashboard
                    $navs['dashboard']=array('desc'=>sprintf('Dashboard'),
                                           'href'=>'dashboard.php',
                                            'title'=>__('Dashboard'));
                    //Custom Code to integrate paid support dashboard
                } else {
                ...
                //Custom Code for Passport Integration
                    ...
                    $navs['status']=array('desc'=>__('Check Ticket Status'),'href'=>'login.php?do=ext&bk=dynabic.passport.client','title'=>'');   
                }
                //Custom Code for Passport Integration
            }
            $this->navs=$navs;
