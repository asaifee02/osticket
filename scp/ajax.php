...
$dispatcher = patterns('',
    //Custom AJAX calls
    url_post("^/issue_count_plus\.(?P<format>xml|json|email)$", array('api.tickets.php:PaidSupportAPIController','issue_count_plus')),
    url_post("^/issue_count_minus\.(?P<format>xml|json|email)$", array('api.tickets.php:PaidSupportAPIController','issue_count_minus')),
    url_post("^/edit_log_comment\.(?P<format>xml|json|email)$", array('api.tickets.php:PaidSupportAPIController','edit_log_comment')),
    url_post("^/delete_staff_comment\.(?P<format>xml|json|email)$", array('api.tickets.php:PaidSupportAPIController','delete_staff_comment')),/* Custom Code for delete comment functionality */
    //Custom AJAX calls
